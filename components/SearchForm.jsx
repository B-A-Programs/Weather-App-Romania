...
const SearchForm = () => {
    ...
    return (
        <form className='mx-24 flex flex-col justify-center content-center gap-12' onSubmit={(e) => {e.preventDefault(); push(`/weather?lat=${lat}&lng=${lng}`)}}>
            ...
            <button type="submit" className='mt-3 rounded-full bg-gradient-to-r flex content-center justify-center pl-5 from-orange-500 to-amber-500 text-white text-lg font-bold py-3 px-8 gap-2'><Image src="/images/search.png" width={30} height={30} />Search</button>
        </form>
    )
}
